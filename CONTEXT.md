...
- A **destination** is the caller-supplied pair of directions Sirannon moves backup bytes through: write a piece, read a piece, and list pieces. Sirannon carries no storage client of its own.
