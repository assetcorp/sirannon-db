...
This turns the latest committed benchmark run into the numbers on the root `BENCHMARKS.md`, and
writes a self-contained `comparison.md` beside that run's result files.
...
The page is hand-written prose with generated regions marked by `<!-- BENCH:<id> START -->` and
