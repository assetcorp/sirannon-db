# @delali/sirannon-vfs-linux-arm64

[![npm](https://img.shields.io/npm/v/@delali/sirannon-vfs-linux-arm64)](https://www.npmjs.com/package/@delali/sirannon-vfs-linux-arm64)
[![license](https://img.shields.io/npm/l/@delali/sirannon-vfs-linux-arm64)](https://github.com/assetcorp/sirannon-db/blob/main/LICENSE)

This package holds one compiled SQLite extension, built for Linux on 64-bit Arm. The extension sends each piece of a Sirannon backup to the destination you supply, so a full copy writes no local file.
