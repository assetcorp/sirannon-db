    ...
    <Card className="border-primary/25 border-dashed py-4 shadow-none">
      <CardContent className="px-4">
        <form className="space-y-2" onSubmit={handleSubmit}>
          <Input value={site} onChange={handleSiteChange} placeholder="Site" autoComplete="off" className="h-8" />
          <Input value={task} onChange={handleTaskChange} placeholder="Task" autoComplete="off" className="h-8" />
