...
import type { HookDispose, HookEvent, HookEventContextMap, HookHandler } from './types.js'
...
export class HookRegistry {
  ...
  async invoke<E extends HookEvent>(event: E, ctx: HookEventContextMap[E]): Promise<void> {
