...
export type AfterQueryHook = (
	ctx: QueryHookContext & { durationMs: number },
) => void | Promise<void>
...
export type BeforeConnectHook = (
	ctx: ConnectionHookContext,
) => void | Promise<void>

/** Hook invoked when a database is opened. */
export type DatabaseOpenHook = (
	ctx: ConnectionHookContext,
) => void | Promise<void>

/** Hook invoked when a database is closed. */
export type DatabaseCloseHook = (
	ctx: ConnectionHookContext,
) => void | Promise<void>
...
export interface LifecycleConfig {
	autoOpen?: {
		resolver: (
			id: string,
		) => { path: string; options?: DatabaseOptions } | undefined
	}
