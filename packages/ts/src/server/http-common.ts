...
export const TABLE_SUBSCRIPTION_NOT_ACCEPTED_MESSAGE =
  'This server keeps table subscriptions off; subscribe to a registered read by name, or give the server acceptSql: true or an onBeforeSubscribe hook'
